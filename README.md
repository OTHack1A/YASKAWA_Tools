...
```
YaskawaTools.exe (Windows) --> sha256:pending — see the v1.1.10 release page
YaskawaTools     (Linux)   --> sha256:pending — see the v1.1.10 release page
YaskawaTools.dmg (macOS)   --> sha256:pending — see the v1.1.10 release page
```
